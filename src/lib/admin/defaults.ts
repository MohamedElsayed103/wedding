...
const CHAPTERS: ChapterEntry[] = [
  {
    ...
    text_en: "We walked different paths… until God brought us together to write one beautiful story.",
  ...
  },
  {
    ...
    text_en: "With every smile, every prayer, and every conversation that never seemed to end, our story grew.",
  ...
  },
  {
    ...
    text_en: "From the prayers of yesterday… to the joy of today, our most beautiful chapter begins.",
